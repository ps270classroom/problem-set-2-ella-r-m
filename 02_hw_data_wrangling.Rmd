...
The type of candidate that sponsored the most promoting ads on average was Democrats running for incumbent seats.
...
fb_top_plot <- ggplot(top_15_us_house_ads, aes(x = impressions_millions, 
  ...
  labs(title = "Total Facebook ad Impressions for all 
       the US House Races Shown by a Histogram",
       x = "Impressions (in millions)",
