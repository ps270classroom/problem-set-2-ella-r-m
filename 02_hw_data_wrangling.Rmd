...
party_incumbent_promote <-filtered_data |> 
  ...
  knitr::kable(party_incumbent_promote,
               ...
               digits = 3,
               col.names = c("party", "incumbency","Promote Values"))      
...
fb_top_plot <- ggplot(top_15_us_house_ads, aes(x = impressions_millions, 
                                              y = cand_name_last)) + geom_bar(aes(fill = party), stat = "identity") + labs(title = "Total Facebook ad Impressions for all the US House Races Shown by a Histogram",
       x = "Impressions (in millions)",
